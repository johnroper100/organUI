...
class FugaraTelemetry {
    ...
    buildPayload() {
        ...
        const organOn = status.organOn === true;
        ...
        return {
            ...
            organState: organOn ? 'on' : 'off',
            organUptimeSeconds: normalizeUptimeSeconds(status.organUptimeSeconds),
            organUptimeLabel: String(status.organUptimeLabel || '').slice(0, 100),
            organUiUptimeSeconds: Math.floor(process.uptime()),
