...
class FugaraTelemetry {
    constructor(options = {}) {
        ...
        this.services = normalizeServices(options.services);
    ...
    buildPayload() {
        ...
        return {
            ...
            organStatus: {
                ...
                idleSeconds: normalizeUptimeSeconds(status.idleSeconds),
                idleSecondsIsLowerBound: status.idleSecondsIsLowerBound === true,
